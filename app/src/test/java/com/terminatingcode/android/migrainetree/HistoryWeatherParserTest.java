...
import com.terminatingcode.android.migrainetree.model.weather.HistoryWeatherParser;
...
public class HistoryWeatherParserTest {
    ...
    public void setUp() throws Exception {
        ...
        mWeather24Hour.setMigraineStart(mCalendar);
    }
    ...
    public void parseDateReturnsDate() throws JSONException, ParseException {
        ...
        Date parseDate = mHistoryWeatherParser.parseDate(date);
        Calendar result = Calendar.getInstance();
        result.setTime(parseDate);
